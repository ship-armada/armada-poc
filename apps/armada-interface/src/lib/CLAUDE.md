...
| `railgun/sync.ts` | Engine balance-update event multiplexer + `refreshShieldedBalances` scan trigger. Shielded reads come from `railgun/shadow-sdk.ts` (@armada/sdk). | Working |
