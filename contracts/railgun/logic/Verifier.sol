 ...
 *      POC MODIFICATION: Added testingMode flag to bypass verification for testing.
 */
contract Verifier is OwnableUpgradeable {
  ...
  // POC: Testing mode bypasses SNARK verification
  // DO NOT ENABLE IN PRODUCTION
  bool public testingMode;

  /**
   * @notice POC: Enable or disable testing mode (bypasses SNARK verification)
  ...
  function verify(Transaction calldata _transaction) public view returns (bool) {
    ...
    // Verify snark proof
    return verifyProof(verifyingKey, _transaction.proof, inputs);
  }

  uint256[48] private __gap; // Reduced by 1 for testingMode
}
