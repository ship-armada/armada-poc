...
/** Sale size parameters (USDC, 6 decimals) — medi-Sepolia values */
...
export const HOP_CONFIGS: readonly [HopConfig, HopConfig, HopConfig] = [
  { ceilingBps: 7000, capUsdc: 50n * 10n ** 6n, maxInvites: 3, maxInvitesReceived: 1 },  // medi-Sepolia
  { ceilingBps: 4500, capUsdc: 20n * 10n ** 6n, maxInvites: 2, maxInvitesReceived: 10 }, // medi-Sepolia
  { ceilingBps: 0, capUsdc: 10n * 10n ** 6n, maxInvites: 0, maxInvitesReceived: 20 },    // medi-Sepolia
] as const
