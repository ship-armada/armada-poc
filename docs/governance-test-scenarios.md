...
| A4 | Vote, then immediately unlock all tokens | **FIXED:** Unlock reverts with cooldown until voting period ends. Covered by `VotingLockerCooldown.t.sol` and `governance_integration.ts` |
