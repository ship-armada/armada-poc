...
async function main() {
  ...
  // Amounts kept small so a single Circle faucet pull (20 USDC) covers a Sepolia run — the deployer
  // needs shieldAmount + the 1-USDC mock yield buffer (~11 USDC). Circuit shapes are amount-agnostic.
  const shieldAmount = ethers.parseUnits('10', 6);
  const transferAmount = ethers.parseUnits('3', 6);
  const unshieldAmount = ethers.parseUnits('1', 6);
  ...
  // ═══════════════════════════════════════════════════════════
  console.log('\n' + '─'.repeat(40));
  console.log(`  STEP 1: SHIELD ${ethers.formatUnits(shieldAmount, 6)} USDC`);
  ...
  // ═══════════════════════════════════════════════════════════
  console.log('\n' + '─'.repeat(40));
  console.log(`  STEP 2: PRIVATE TRANSFER ${ethers.formatUnits(transferAmount, 6)} USDC`);
  console.log('─'.repeat(40));
  ...
  // ═══════════════════════════════════════════════════════════
  console.log('\n' + '─'.repeat(40));
  console.log(`  STEP 3: UNSHIELD ${ethers.formatUnits(unshieldAmount, 6)} USDC`);
  console.log('─'.repeat(40));
  ...
  console.log('='.repeat(60));
  console.log(`  ✓ Shield:   ${ethers.formatUnits(shieldAmount, 6)} USDC shielded (Armada vkeys on-chain)`);
  console.log(`  ✓ Transfer: ${ethers.formatUnits(transferAmount, 6)} USDC sent (1x2 circuit, proof generated by Armada WASM/ZKEY)`);
  console.log(`  ✓ Unshield: ${ethers.formatUnits(unshieldAmount, 6)} USDC withdrawn (proof generated by Armada WASM/ZKEY)`);
