...
export interface MockUSDCV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addMinter"
      | "allowance"
...
export interface MockUSDCV2 extends BaseContract {
  connect(runner?: ContractRunner | null): MockUSDCV2;
  waitForDeployment(): Promise<this>;

  interface: MockUSDCV2Interface;
