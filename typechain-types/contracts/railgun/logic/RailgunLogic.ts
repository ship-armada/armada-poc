...
export interface RailgunLogicInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ZERO_VALUE"
      | "addToBlocklist"
...
export interface RailgunLogic extends BaseContract {
  connect(runner?: ContractRunner | null): RailgunLogic;
  ...
  ): TypedContractMethod<[_testingMode: boolean], [void], "nonpayable">;
  getFunction(
