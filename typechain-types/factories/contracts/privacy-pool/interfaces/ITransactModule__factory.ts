...
import type {
  ITransactModule,
  ITransactModuleInterface,
} from "../../../../contracts/privacy-pool/interfaces/ITransactModule";
...
export class ITransactModule__factory {
  static readonly abi = _abi;
  static createInterface(): ITransactModuleInterface {
    return new Interface(_abi) as ITransactModuleInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ITransactModule {
    return new Contract(address, _abi, runner) as unknown as ITransactModule;
  }
}
